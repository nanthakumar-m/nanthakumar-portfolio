...
const ProjectsSection = () => {
  ...
  const filters = ["all", "featured", ...allTechnologies.slice(0, 6)]; // Limit filters
  ...
  const ProjectCard = ({ project, index }) => {
    return (
      <motion.div
        ...
        className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-700/50 hover:border-blue-500/30 transition-all duration-500">
        {/* Project Image */}
        ...
        <motion.div
          ...
          {filteredProjects.length > 0 && (
            <motion.div variants={itemVariants} className="text-center mt-16">
              <a
                href={personalInfo.socialLinks.github} // 🔁 Replace with your GitHub URL
                target="_blank"
                rel="noopener noreferrer">
                <motion.button
                  whileHover={{ scale: 1.05 }}
